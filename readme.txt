...
1. **(Recommended)** Install directly from the WP Directory through your admin panel Plugins > Add New > Search for "NextCellent Gallery Madia Library Addon". Click install under the name, and activate when prompted. 
